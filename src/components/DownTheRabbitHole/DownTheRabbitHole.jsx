...
import styles from './DownTheRabbitHole.module.css';

const DownTheRabbitHole = () => {
    const { ref: tunnelRef } = useWebAnimations({
        keyframes: [
    ...
    const { ref: aliceRef } = useWebAnimations({
        keyframes: [
            { color: '#000', transform: 'rotate(0) translate3D(-50%, -50%, 0)' },
            { color: '#431236', offset: 0.3 },
            { color: '#000', transform: 'rotate(360deg) translate3D(-50%, -50%, 0)' },
        ],
        timing: {
            duration: 3000,
            iterations: Infinity,
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.tunnel} ref={tunnelRef}></div>
            <div className={styles.alice} ref={aliceRef}>
...
export default DownTheRabbitHole
